...
def wa_helm(g, p=None):
    ...
    hy = n*0.28; hr = n*0.26                                    # большая голова — выше и шире
...
def wa_chest(g, p=None):
    n = g.n; cx = n/2; st = PAL['steel']; gold = PAL['gold']
    g.ellipse(cx, n*0.66, n*0.13, n*0.10, st[0])               # компактный нагрудник
    g.ellipse(cx-n*0.05, n*0.63, n*0.08, n*0.05, st[2])        # верхний блик
    g.line(cx, n*0.60, cx, n*0.72, st[1], 1)                    # шов
    g.ellipse(cx, n*0.65, n*0.025, n*0.02, gold[0])           # эмблема

def wa_shoulders(g, p=None):
    n = g.n; cx = n/2; st = PAL['steel']
    for s in (-1, 1):
        g.ellipse(cx+s*n*0.14, n*0.60, n*0.055, n*0.045, st[0])  # мини-наплечники
        g.ellipse(cx+s*n*0.14, n*0.58, n*0.045, n*0.03, st[2])
...
# Большая голова 3/4 сбоку (лицо повёрнуто вправо: глаз/нос/рот справа, «затылок»
# слева). Токены: h=убор/волосы, H=тень убора, r=прядь волос, s=кожа, d=тень кожи,
# o=контур, e=глаз, w=блик, g=свеч/рог. 8 строк — голова доминирует над телом.
def _head(kind):
    # Лицо упрощено: акцент — крупный выразительный глаз (+блик). Без рта/лишних
    # черт, чтобы читалась именно раса (уши/рога/крылья и т.п.).
    base = [
        _row(('.',4),('o',6),('.',4)),                                              # 0 макушка
        _row(('.',3),('o',1),('h',2),('r',3),('h',1),('o',1),('.',3)),              # 1 волосы+прядь
        _row(('.',3),('o',1),('h',2),('s',4),('o',1),('.',3)),                      # 2 лоб (чёлка слева)
        _row(('.',3),('o',1),('h',1),('s',1),('e',2),('s',1),('o',1),('.',4)),      # 3 глаз (акцент)
        _row(('.',3),('o',1),('s',2),('e',1),('w',1),('s',1),('o',1),('.',4)),      # 4 глаз+блик
        _row(('.',3),('o',1),('s',6),('o',1),('.',3)),                              # 5 щека
        _row(('.',3),('o',1),('s',6),('o',1),('.',3)),                              # 6 чистая кожа
        _row(('.',4),('o',1),('s',4),('o',1),('.',4)),                              # 7 подбородок (уже)
    ]
    if kind == 'hood':
        base[0] = _row(('.',3),('o',2),('h',2),('o',2),('.',3),('.',2))[:W]
        base[0] = _row(('.',4),('o',6),('.',4))
        base[1] = _row(('.',3),('o',1),('h',6),('o',1),('.',3))
        base[2] = _row(('.',3),('o',1),('h',1),('s',4),('h',1),('o',1),('.',3))
        base[7] = _row(('.',3),('o',1),('h',1),('s',4),('o',1),('.',4))
    elif kind == 'ears':
        ...
        base[3] = _row(('.',2),('o',1),('t',3),('r',2),('t',3),('o',1),('.',2))
    elif kind == 'stone':
        base[1] = _row(('.',3),('o',1),('h',6),('o',1),('.',3))
        base[3] = _row(('.',3),('o',1),('h',1),('s',1),('g',2),('s',1),('o',1),('.',4))  # светящийся глаз
...
def _body(style, frame):
    ...
    if style == 'stocky':        # дворф: широкий приземистый, толстые сапоги
        return [
            ...
            _row(('.',3+dx),('b',3),('.',2),('b',3),('.',3-dx)),                            # толстые сапоги
            _row(('.',3+dx),('o',3),('.',2),('o',3),('.',3-dx)),
        ]
    if style == 'rock':          # голем: каменные плиты, трещины, светящееся ядро
        return [
            ...
            _row(('.',3+dx),('C',3),('.',2),('C',3),('.',3-dx)),                            # каменные ноги
            _row(('.',3+dx),('o',3),('.',2),('o',3),('.',3-dx)),
        ]
    if style == 'spiky':         # демон: шипастые наплечники
        return [
            ...
            _row(('.',3),('o',1),('c',1),('g',1),('C',1),('c',1),('o',1),('.',4)),          # грудь+эмблема
            _row(('.',4),('o',1),('t',1),('g',1),('t',2),('o',1),('.',4)),                  # пояс
            _row(('.',4+dx),('C',2),('.',2),('C',2),('.',4-dx)),                            # ноги
            _row(('.',4+dx),('b',2),('.',2),('b',2),('.',4-dx)),
        ]
...
def f_race(g, cfg, frame):
    ...
    # борода дворфа — прямо под лицом (в нижней части головы)
    if feat == 'beard':
        rows[6] = _row(('.',3),('o',1),('g',6),('o',1),('.',3))
        rows[7] = _row(('.',4),('o',1),('g',4),('o',1),('.',4))
