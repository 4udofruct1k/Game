...
# Голова 3/4 сбоку (лицо повёрнуто вправо: глаз смещён вправо, «затылок» слева).
# Строки 0..6, ширина W. Токены: h=убор,H=тень убора,s=кожа,o=контур,g=свеч/рог.
def _head(kind):
    base = [
        _row(('.',4),('o',6),('.',4)),
        _row(('.',3),('o',1),('h',6),('o',1),('.',3)),
        _row(('.',3),('o',1),('h',6),('o',1),('.',3)),
        _row(('.',3),('o',1),('h',1),('s',5),('o',1),('.',3)),
        _row(('.',3),('o',1),('s',6),('o',1),('.',3)),
        _row(('.',3),('o',1),('s',3),('e',2),('s',1),('o',1),('.',3)),
        _row(('.',3),('o',1),('s',6),('o',1),('.',3)),
    ]
    if kind == 'hood':
        base[0] = _row(('.',5),('o',4),('.',5))
        base[1] = _row(('.',4),('o',1),('h',4),('o',1),('.',4))
        base[3] = _row(('.',3),('o',1),('h',1),('s',5),('o',1),('.',3))
        base[6] = _row(('.',3),('o',1),('h',1),('s',5),('o',1),('.',3))
    elif kind == 'ears':
        base[0] = _row(('.',3),('o',1),('.',1),('o',1),('.',2),('o',1),('.',1),('o',1),('.',3))
        base[1] = _row(('.',3),('o',1),('h',1),('o',1),('.',2),('o',1),('h',1),('o',1),('.',3))
        base[2] = _row(('.',3),('o',1),('h',6),('o',1),('.',3))
    elif kind == 'helm':
        base[1] = _row(('o',1),('w',1),('o',1),('h',8),('o',1),('w',1),('o',1))
        base[2] = _row(('.',3),('o',1),('h',6),('o',1),('.',3))
        base[3] = _row(('.',3),('o',1),('h',1),('s',5),('o',1),('.',3))
    elif kind == 'horns':
        base[0] = _row(('.',3),('g',1),('o',1),('.',4),('o',1),('g',1),('.',3))
        base[1] = _row(('.',3),('g',1),('h',6),('g',1),('.',3))
        base[2] = _row(('.',3),('o',1),('h',6),('o',1),('.',3))
    elif kind == 'wizard':
        base[0] = _row(('.',6),('o',2),('.',6))
        base[1] = _row(('.',5),('o',1),('h',2),('o',1),('.',5))
        base[2] = _row(('.',3),('o',1),('h',6),('o',1),('.',3))
        base[3] = _row(('.',2),('o',1),('t',8),('o',1),('.',2))
    elif kind == 'stone':
        base[3] = _row(('.',3),('o',1),('h',1),('g',1),('h',4),('o',1),('.',3))
        base[6] = _row(('.',3),('o',1),('h',6),('o',1),('.',3))
    elif kind == 'dragon':
        base[0] = _row(('.',3),('g',1),('o',1),('.',4),('o',1),('g',1),('.',3))
        base[5] = _row(('.',2),('o',1),('s',4),('e',2),('s',1),('o',1),('.',... )) if False else _row(('.',2),('o',1),('s',3),('e',2),('s',2),('o',1),('.',2))
        base[6] = _row(('.',2),('o',1),('s',7),('d',1),('o',1),('.',2))
    return base
...
def f_race(g, cfg, frame):
    ...
    rows = _head(kind)[:]
    # тело/руки (упрощённо, рука с оружием вынесена вправо — вид сбоку)
    rows += [
        _row(('.',4),('o',1),('d',4),('o',1),('.',4)),                       # шея
        _row(('.',2),('o',1),('c',8),('o',1),('.',2)),                       # плечи
        _row(('.',2),('o',1),('c',8),('o',1),('.',2)),
        _row(('.',2),('o',1),('c',8),('o',1),('s',1),('.',1)),               # рука-кисть справа
        _row(('.',2),('o',1),('t',8),('o',1),('.',2)),                       # пояс
        _row(('.',2),('o',1),('c',8),('o',1),('.',2)),
    ]
    # ноги (шаг по кадру)
    if frame == 0:
        rows += [_row(('.',3),('c',3),('.',2),('c',3),('.',3)),
                 _row(('.',3),('b',3),('.',2),('b',3),('.',3)),
                 _row(('.',3),('o',3),('.',2),('o',3),('.',3))]
    else:
        rows += [_row(('.',2),('c',3),('.',3),('c',3),('.',3)),
                 _row(('.',2),('b',3),('.',3),('b',3),('.',3)),
                 _row(('.',2),('o',3),('.',3),('o',3),('.',3))]
    # борода дворфа
    if feat == 'beard':
