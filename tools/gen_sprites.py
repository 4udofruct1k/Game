...
RACE_CFG = {
    ...
    'dragonkin': {'body': ((70,148,86),(38,98,50),(150,208,118)), 'skin': ((110,172,96),(70,120,64)), 'feat': 'scales', 'horn': (56,94,52), 'eyeglow': (245,224,92), 'trim': (240,220,120), 'hat': (56,94,52), 'wing': (44,120,70)},
}
...
def f_race(g, cfg, frame):
    ...
    rows = _head(kind)[:]
    # КОМПАКТНОЕ узкое тело без шеи (ЯВНО уже головы, чтобы голова читалась крупной).
    # Воротник-кант отделяет голову от корпуса. Детали: наплечники-блик, эмблема,
    # пояс с пряжкой, кисть с оружием вынесена вправо.
    rows += [
        _row(('.',4),('o',1),('t',4),('o',1),('.',4)),                              # воротник (кант-разделитель)
        _row(('.',4),('o',1),('l',1),('c',2),('l',1),('o',1),('s',1),('.',3)),      # плечи+блик, кисть справа
        _row(('.',4),('o',1),('c',1),('g',1),('C',1),('c',1),('o',1),('.',4)),      # грудь+эмблема
        _row(('.',4),('o',1),('t',1),('g',1),('t',2),('o',1),('.',4)),              # пояс с пряжкой
    ]
    # короткие малозаметные ножки (2 ряда, узкие, тёмные; шаг по кадру)
    if frame == 0:
        rows += [_row(('.',4),('C',2),('.',2),('C',2),('.',4)),
                 _row(('.',4),('b',2),('.',2),('b',2),('.',4))]
    else:
        rows += [_row(('.',3),('C',2),('.',2),('C',2),('.',5)),
                 _row(('.',3),('b',2),('.',2),('b',2),('.',5))]
